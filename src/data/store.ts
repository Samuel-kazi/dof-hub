...
import { upgradeToV10, upgradeToV11, upgradeToV12, upgradeToV13, upgradeToV3, upgradeToV4, upgradeToV5, upgradeToV6, upgradeToV7, upgradeToV8, upgradeToV9 } from "./migrate";
...
export function upgradeDb(parsed: Database): Database | null {
  switch (parsed.schemaVersion) {
    ...
    case 1: return upgradeToV13(upgradeToV12(upgradeToV11(upgradeToV10(upgradeToV9(upgradeToV8(upgradeToV7(upgradeToV6(upgradeToV5(upgradeToV4(upgradeToV3(migrate(parsed))))))))))));
    case 2: return upgradeToV13(upgradeToV12(upgradeToV11(upgradeToV10(upgradeToV9(upgradeToV8(upgradeToV7(upgradeToV6(upgradeToV5(upgradeToV4(upgradeToV3(parsed)))))))))));
    case 3: return upgradeToV13(upgradeToV12(upgradeToV11(upgradeToV10(upgradeToV9(upgradeToV8(upgradeToV7(upgradeToV6(upgradeToV5(upgradeToV4(parsed))))))))));
    case 4: return upgradeToV13(upgradeToV12(upgradeToV11(upgradeToV10(upgradeToV9(upgradeToV8(upgradeToV7(upgradeToV6(upgradeToV5(parsed)))))))));
    case 5: return upgradeToV13(upgradeToV12(upgradeToV11(upgradeToV10(upgradeToV9(upgradeToV8(upgradeToV7(upgradeToV6(parsed))))))));
    case 6: return upgradeToV13(upgradeToV12(upgradeToV11(upgradeToV10(upgradeToV9(upgradeToV8(upgradeToV7(parsed)))))));
    case 7: return upgradeToV13(upgradeToV12(upgradeToV11(upgradeToV10(upgradeToV9(upgradeToV8(parsed))))));
    case 8: return upgradeToV13(upgradeToV12(upgradeToV11(upgradeToV10(upgradeToV9(parsed)))));
    case 9: return upgradeToV13(upgradeToV12(upgradeToV11(upgradeToV10(parsed))));
    case 10: return upgradeToV13(upgradeToV12(upgradeToV11(parsed)));
    case 11: return upgradeToV13(upgradeToV12(parsed));
    case 12: return upgradeToV13(parsed);
    default: return null;
  }
}
