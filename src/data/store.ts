...
import { upgradeToV3, upgradeToV4, upgradeToV5, upgradeToV6, upgradeToV7, upgradeToV8 } from "./migrate";
...
export function upgradeDb(parsed: Database): Database | null {
  switch (parsed.schemaVersion) {
    ...
    case 1: return upgradeToV8(upgradeToV7(upgradeToV6(upgradeToV5(upgradeToV4(upgradeToV3(migrate(parsed)))))));
    case 2: return upgradeToV8(upgradeToV7(upgradeToV6(upgradeToV5(upgradeToV4(upgradeToV3(parsed))))));
    case 3: return upgradeToV8(upgradeToV7(upgradeToV6(upgradeToV5(upgradeToV4(parsed)))));
    case 4: return upgradeToV8(upgradeToV7(upgradeToV6(upgradeToV5(parsed))));
    case 5: return upgradeToV8(upgradeToV7(upgradeToV6(parsed)));
    case 6: return upgradeToV8(upgradeToV7(parsed));
    case 7: return upgradeToV8(parsed);
    default: return null;
  }
}
