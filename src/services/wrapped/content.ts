...
export const approveDevotionalReview = rpc("content.approveDevotionalReview", core.approveDevotionalReview);
export const approveGuestReview = rpc("content.approveGuestReview", core.approveGuestReview);
export const closeDevotional = rpc("content.closeDevotional", core.closeDevotional);
...
export const sendBackDevotionalToEditing = rpc("content.sendBackDevotionalToEditing", core.sendBackDevotionalToEditing);
export const sendBackStage = rpc("content.sendBackStage", core.sendBackStage);
export const setDevotionalReadyForReview = rpc("content.setDevotionalReadyForReview", core.setDevotionalReadyForReview);
